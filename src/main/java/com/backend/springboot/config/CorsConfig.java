 ...
 * @Configuration
 * 
 * @EnableWebMvc public class CorsConfig implements WebMvcConfigurer {
 * 
 * @Override public void addCorsMappings(CorsRegistry registry) {
 * registry.addMapping("/api/v1/employees")
 * .allowedOrigins("http://localhost:4200") .allowedMethods("GET", "POST",
 * "PUT", "DELETE") .allowedHeaders("*") .allowCredentials(true) .maxAge(3600);
 * } }
 */
